...
🔍 Workflow
Data loading and cleaning (checked for missing values/duplicates)
Feature engineering (created average_score column)
Exploratory Data Analysis with visualizations
Built a Logistic Regression model to predict Pass/Fail
