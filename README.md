Here it is directly, no file:

**📊 Student Performance Analysis**

An Exploratory Data Analysis (EDA) project examining how demographic and background factors influence student exam performance, along with a basic predictive model to classify Pass/Fail outcomes.
...
![Gender vs Average Score](chart1_gender.png)
...
![Score Distribution](chart2_dist.png)
...
![Parental Education vs Score](chart3_parent.png)
...
![Test Preparation vs Score](chart4_prep.png)
...
![Correlation Heatmap](chart5_corr.png)
